...
public static class TimeoutConstants
{
    ...
    /// </summary>
    public static readonly TimeSpan ModDBDiscoveryBrowserTimeout = TimeSpan.FromSeconds(ModDBDiscoveryBrowserTimeoutSeconds);

    /// <summary>
    /// Gets the ModDB discovery selector timeout as a TimeSpan.
    /// </summary>
    public static readonly TimeSpan ModDBDiscoverySelectorTimeout = TimeSpan.FromSeconds(ModDBDiscoverySelectorTimeoutSeconds);

    /// <summary>
    /// Gets the default HTTP request timeout as a TimeSpan.
    /// </summary>
    public static readonly TimeSpan DefaultHttpRequest = TimeSpan.FromSeconds(DefaultHttpRequestSeconds);

    /// <summary>
    /// Gets the catalog refresh timeout as a TimeSpan.
    /// </summary>
    public static readonly TimeSpan CatalogRefresh = TimeSpan.FromSeconds(CatalogRefreshSeconds);
