...
public static class GitHubConstants
{
    ...
    /// <summary>Metadata key for asset name.</summary>
    public const string AssetNameMetadataKey = "asset-name";

    /// <summary>Gets common language patterns and their display names.</summary>
    public static readonly System.Collections.ObjectModel.ReadOnlyDictionary<string, string> LanguagePatterns = new(new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        { "english", "English" },
        { "russian", "Russian" },
        { "spanish", "Spanish" },
    ...
    public static readonly System.Collections.ObjectModel.ReadOnlyDictionary<string, string> ResolutionDisplayNames = new(new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        { "1280x720", "720p" },
        { "1366x768", "768p" },
        { "1600x900", "900p" },
    ...
    public static readonly System.Collections.ObjectModel.ReadOnlyCollection<string> ArchiveExtensions = new(new[]
    {
        ".zip", ".7z", ".rar", ".tar.gz", ".tgz",
    });

    /// <summary>Gets filenames to exclude from variant splitting (source code, etc.).</summary>
    public static readonly System.Collections.ObjectModel.ReadOnlyCollection<string> ExcludedPatterns = new(new[]
    {
