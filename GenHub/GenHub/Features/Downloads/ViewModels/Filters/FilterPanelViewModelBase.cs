...
public abstract partial class FilterPanelViewModelBase : ObservableObject, IFilterPanelViewModel
{
    ...
    /// </summary>
    /// <param name="triggerApply">A value indicating whether to trigger the manual apply filter flow.</param>
    protected void NotifyFiltersChanged(bool triggerApply = true)
    {
